...
from gallery.forms import AlbumForm, AlbumImageForm, ImageTagForm, TagMappingForm
...
class ImageTagModelAdmin(admin.ModelAdmin):
    form = ImageTagForm

@admin.register(TagMapping)
class TagMappingModelAdmin(admin.ModelAdmin):
    form = TagMappingForm